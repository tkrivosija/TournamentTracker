    ...
    public static class TextConnectorProcessor
    {
        ...
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
            ...
            foreach(string id in ids)
            {
                foreach(string entry in entries)
                {
                    ...
                    if (cols[0] == id) matchingEntries.Add(entry);
                }
            }
        ...
        public static List<MatchupEntryModel> ConvertToMatchupEntryModels(this List<string> lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                else m.TeamCompeting = LookupTeamById(int.Parse(cols[1]));
                m.Score = double.Parse(cols[2]);
                int parentId = 0;
                if (int.TryParse(cols[3],out parentId)) m.ParentMatchup = LookupMatchupById(int.Parse(cols[3]));
                else m.ParentMatchup = null;
        ...
        public static List<MatchupModel> ConvertToMatchupModels(this List<String> lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                else p.Winner = LookupTeamById(int.Parse(cols[2]));
        ...
        public static void UpdateMatchupToFile(this MatchupModel matchup)
        {
            ...
            {
                string parent = "";
                if (m.Winner != null) parent = m.Winner.Id.ToString();
                lines.Add($"{ m.Id },{ ConvertMatchupEntryListToString(m.Entries) },{ parent },{ m.MatchupRound }");
            }
        ...
        private static string ConvertRoundListToString(List<List<MatchupModel>> rounds)
        {
            ...
            if (rounds.Count > 0) output = output.Substring(0, output.Length - 1);
            return output;
        }
        ...
        private static string ConvertMatchupListToString(List<MatchupModel> matchups)
        {
            ...
            if (matchups.Count > 0) output = output.Substring(0, output.Length - 1);
            return output;
        }
        ...
        private static string ConvertMatchupEntryListToString(List<MatchupEntryModel> entries)
        {
            ...
            if (entries.Count > 0) output = output.Substring(0, output.Length - 1);
            return output;
        }
        ...
        private static string ConvertPrizeListToString(List<PrizeModel> prizes)
        {
            ...
            if (prizes.Count > 0) output = output.Substring(0, output.Length - 1);
            return output;
        }
        ...
        private static string ConvertTeamListToString(List<TeamModel> teams)
        {
            ...
            if (teams.Count > 0) output = output.Substring(0, output.Length - 1);
            return output;
        }
        ...
        private static string ConvertPeopleListToString(List<PersonModel> people)
        {
            ...
            if(people.Count>0)output = output.Substring(0, output.Length - 1);
            return output;
        }
    }
}
